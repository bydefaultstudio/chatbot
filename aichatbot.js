    ...
    (function() {
        const fontCSS = `
          @font-face {
            ...
            src: url('https://cdn.jsdelivr.net/gh/bydefaultstudio/chatbot@main/font/bugrino-black-webfont.woff2') format('woff2'),
                 url('https://cdn.jsdelivr.net/gh/bydefaultstudio/chatbot@main/font/bugrino-black-webfont.woff') format('woff');
            font-weight: normal;
            font-style: normal;   
          }
          @font-face {
            font-family: 'bugrinobold';
            src: url('https://cdn.jsdelivr.net/gh/bydefaultstudio/chatbot@main/font/bugrino-bold-webfont.woff2') format('woff2'),
                 url('https://cdn.jsdelivr.net/gh/bydefaultstudio/chatbot@main/font/bugrino-bold-webfont.woff') format('woff');
            font-weight: normal;
            font-style: normal;
          }
          @font-face {
            font-family: 'bugrinofine';
            src: url('https://cdn.jsdelivr.net/gh/bydefaultstudio/chatbot@main/font/bugrino-fine-webfont.woff2') format('woff2'),
                 url('https://cdn.jsdelivr.net/gh/bydefaultstudio/chatbot@main/font/bugrino-fine-webfont.woff') format('woff');
            font-weight: normal;
            font-style: normal;
          }
          @font-face {
            font-family: 'bugrinoheavy';
            src: url('https://cdn.jsdelivr.net/gh/bydefaultstudio/chatbot@main/font/bugrino-heavy-webfont.woff2') format('woff2'),
                 url('https://cdn.jsdelivr.net/gh/bydefaultstudio/chatbot@main/font/bugrino-heavy-webfont.woff') format('woff');
            font-weight: normal;
            font-style: normal;
          }
          @font-face {
            font-family: 'bugrinolight';
            src: url('https://cdn.jsdelivr.net/gh/bydefaultstudio/chatbot@main/font/bugrino-light-webfont.woff2') format('woff2'),
                 url('https://cdn.jsdelivr.net/gh/bydefaultstudio/chatbot@main/font/bugrino-light-webfont.woff') format('woff');
            font-weight: normal;
            font-style: normal;
          }
          @font-face {
            font-family: 'bugrinomedium';
            src: url('https://cdn.jsdelivr.net/gh/bydefaultstudio/chatbot@main/font/bugrino-medium-webfont.woff2') format('woff2'),
                 url('https://cdn.jsdelivr.net/gh/bydefaultstudio/chatbot@main/font/bugrino-medium-webfont.woff') format('woff');
            font-weight: normal;
            font-style: normal;
          }
          @font-face {
            font-family: 'bugrinoregular';
            src: url('https://cdn.jsdelivr.net/gh/bydefaultstudio/chatbot@main/font/bugrino-regular-webfont.woff2') format('woff2'),
                 url('https://cdn.jsdelivr.net/gh/bydefaultstudio/chatbot@main/font/bugrino-regular-webfont.woff') format('woff');
            font-weight: normal;
            font-style: normal;
          }
          @font-face {
            font-family: 'bugrinosemibold';
            src: url('https://cdn.jsdelivr.net/gh/bydefaultstudio/chatbot@main/font/bugrino-semibold-webfont.woff2') format('woff2'),
                 url('https://cdn.jsdelivr.net/gh/bydefaultstudio/chatbot@main/font/bugrino-semibold-webfont.woff') format('woff');
            font-weight: normal;
            font-style: normal;
          }
          @font-face {
            font-family: 'bugrinothin';
            src: url('https://cdn.jsdelivr.net/gh/bydefaultstudio/chatbot@main/font/bugrino-thin-webfont.woff2') format('woff2'),
                 url('https://cdn.jsdelivr.net/gh/bydefaultstudio/chatbot@main/font/bugrino-thin-webfont.woff') format('woff');
            font-weight: normal;
            font-style: normal;
          }
        `;
